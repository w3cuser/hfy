...
LoadingJS.prototype = {
    ...
    init: function () {
        ...
        var windowWidth = doc.width(),
            windowHeight = Math.max(doc.height(), 400),
            progressWidth = 480,
            progressHeight = 70;

        var progressLeft = (windowWidth - progressWidth) / 2,
            progressTop = (windowHeight - progressHeight) / 2;
    ...
    addLoadingImage: function () {
        ...
        this.loadingImg.load(function () {
            ...
            var doc = $(document),
                ...
                oImage = self.loadingImg[0];
            var iImageWidth = oImage.naturalWidth,
                iImageHeight = oImage.naturalHeight;
            ...
            var iLeft = (windowWidth - iImageWidth) / 2,
                iTop = iInstanceTop - iImageHeight;
